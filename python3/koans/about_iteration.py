...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Reduce applies a specified function to the first two items in a sequence,
        # then applies it to the result and the next item in the sequence, and
        # continues until there are no more items left in the sequence and returns
        # the result
    # ------------------------------------------------------------------
